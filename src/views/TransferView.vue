<script setup>
    ...
    const accountBalance = store.accountBalance;
...
<script >
    ...
    export default {
        ...
        methods: {
            ...
            submit(){
                let text = "Transfer "+this.amount+" to \n Name: Shalom\n  \nBank: "+this.bank+"  \n\nConfirm or Cancel.";
        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <button type="button" class="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger"
                    id="topnav-hamburger-icon" @click="S">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="pages-profile.html"><i
                                ...
                                class="align-middle">Balance : <b>NGN {{ accountBalance }}</b></span></a>
                                <div class="dropdown-divider"></div>
                        
                        <RouterLink to="/" class="dropdown-item"><i
                                class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle" data-key="t-logout">Logout</span></RouterLink>
                    </div>
                </div>
            </div>
        </div>
            ...
            <!-- ========== App Menu ========== -->
            <div class="app-menu navbar-menu" id="showStatus">
                <!-- LOGO -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Hello, {{ username }}</h4>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Transfer Cash</h4>
                                    <div class="flex-shrink-0">
                                        <div class="form-check form-switch form-switch-right form-switch-md">
                                           Current Bal: &#x20A6; {{ accountBalance }}
                                        </div>
                                    </div>
                                </div><!-- end card header -->
                                <div class="card-body">
                                    <div class="live-preview">
                                        <div class="row gy-4">
                                            <div class="col-xxl-12 col-md-12">
                                                <div>
                                                    <label for="basiInput" class="form-label">Enter Amount</label>
                                                    <input type="number" class="form-control" id="basiInput" v-model="amount">
                                                </div>
                                                <br/>
                                                <div>
                                                    <label for="basiInput" class="form-label">Select Bank</label>
                                                    <select class="form-select mb-3" aria-label="Default select example" v-model="bank">
                                                 ...
                                                 <div>
                                                    <label for="basiInput" class="form-label">Enter Account number</label>
                                                    <input type="number" class="form-control" id="basiInput" v-model="accountNumber">
                                                </div>
                                                
                                            </div>
                                            <center>

                                                <button type="button" class="btn btn-success bg-gradient waves-effect waves-light" style="width:80%" @click="submit">Submit</button>
