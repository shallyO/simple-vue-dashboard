! function() {
    ...
    function I() {
        ...
        }), document.getElementById("topnav-hamburger-icon").addEventListener("click", S);
    ...
    function T(e) {
        if (e == e) {
            switch (e["data-layout"]) {
                case "vertical":
                    C("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), z("vertical"), f();
                    break;
                case "horizontal":
                ...
                case "twocolumn":
                    ...
                    break;
                default:
                    "vertical" == sessionStorage.getItem("data-layout") && sessionStorage.getItem("data-layout") ? (C("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), z("vertical"), f()) : "horizontal" == sessionStorage.getItem("data-layout") ? (C("data-layout", "horizontal"), sessionStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), z("horizontal")) : "twocolumn" == sessionStorage.getItem("data-layout") && (C("data-layout", "twocolumn"), sessionStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), z("twocolumn"))
            }
    ...
    sessionStorage.getItem("defaultAttribute") ? ((a = {})["data-layout"] = sessionStorage.getItem("data-layout"), a["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), a["data-layout-mode"] = sessionStorage.getItem("data-layout-mode"), a["data-layout-width"] = sessionStorage.getItem("data-layout-width"), a["data-sidebar"] = sessionStorage.getItem("data-sidebar"), a["data-layout-position"] = sessionStorage.getItem("data-layout-position"), a["data-layout-style"] = sessionStorage.getItem("data-layout-style"), a["data-topbar"] = sessionStorage.getItem("data-topbar"), T(a)) : (i = document.documentElement.attributes, a = {}, i.forEach(function(e) {
        ...
        }), I(), k(), v(), document.getElementsByClassName("dropdown-item-cart") && (r = document.querySelectorAll(".dropdown-item-cart").length, document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn").forEach(function(e) {
            e.addEventListener("click", function(e) {
                r--, this.closest(".dropdown-item-cart").remove(), document.getElementsByClassName("cartitem-badge").forEach(function(e) {
                    e.innerHTML = r
                }), H(), document.getElementById("empty-cart").style.display = 0 == r ? "block" : "none", document.getElementById("checkout-elem").style.display = 0 == r ? "none" : "block"
            })
        }), document.getElementsByClassName("cartitem-badge").forEach(function(e) {
            e.innerHTML = r
        }), document.getElementById("empty-cart").style.display = "none", document.getElementById("checkout-elem").style.display = "block", H()), document.getElementsByClassName("notification-check") && document.querySelectorAll(".notification-check input").forEach(function(e) {
            e.addEventListener("click", function(e) {
        ...
        }(), f(), q(), window.addEventListener("resize", function() {
